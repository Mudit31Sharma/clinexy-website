...
export const metadata: Metadata = {
  title: "Telehealth & Digital Prescriptions",
...
const jsonLd2 = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Teleconsultation Digital Prescriptions For Doctors",
      "item": "https://www.clinexy.com/teleconsultation-digital-prescriptions-for-doctors"
    }
  ]
};
...
const jsonLd3 = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is Telehealth & Digital Prescriptions included in the plan?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does Telehealth & Digital Prescriptions work for my specialty?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Can I integrate Telehealth & Digital Prescriptions with my existing tools?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<p className="hero-sub">Video consults via Google Meet. Branded prescriptions generated in minutes. Compliant in your region.</p><ul className="point-list hero-points"><li>See patients anywhere by secure video.</li><li>Book, consult, and prescribe in one place.</li><li>Keep patients who move away or travel.</li></ul>
...
<img className="hero-photo" src="/assets/img/telehealth.svg" alt="Telehealth & Digital Prescriptions" loading="eager" width="600" height="420" />
<div className="hero-photo-badge">
<div className="badge-dot"></div><span>Live booking system</span>
</div></div>
</div>
</div></header>
<nav className="breadcrumbs"><div className="container"><Link href="/">Home</Link><span className="crumb-sep">›</span><span className="crumb-current">Teleconsultation Digital Prescriptions For Doctors</span></div></nav>
<aside className="quick-answer container"><div className="quick-answer-inner"><div className="quick-answer-label">Quick answer</div><p>Telehealth & Digital Prescriptions from Clinexy is built specifically for solo healthcare professionals. It is included in the base subscription with no add-on fees and no per-appointment commissions. Setup takes minutes, not days, and works across regions with compliance for HIPAA, GDPR, PIPEDA, PDPA, and DPDP.</p></div></aside>
<section className="section"><div className="container"><h2>What is Telehealth & Digital Prescriptions</h2><p className="lead">Telehealth & Digital Prescriptions is the part of Clinexy that handles this specific job for your practice.</p></div></section>
...
<section className="section"><div className="container"><h2>How Clinexy solves it</h2><p className="lead">Clinexy ships Telehealth & Digital Prescriptions as part of the base subscription. No add-on fees. No setup work. Templates pre-configured for solo practice.</p></div></section>
