...
export const metadata: Metadata = {
  title: "About Clinexy: Build. Brand. Grow.",
  description: "Clinexy helps solo healthcare professionals build their brand, grow their practice, and automate their admin, so they can focus on patient care.",
...
const faqs = [
  { q: "What does Clinexy do?", a: "Clinexy helps solo healthcare professionals build their brand, grow their practice, and automate the admin, so they can focus on patient care." },
  { q: "Who is behind Clinexy?", a: "A team focused on giving independent practitioners the online presence and automation that larger clinics take for granted." },
  { q: "Where does Clinexy operate?", a: "Across India, the UK, Canada, Singapore, Australia, and more, with local pricing and compliance." },
  { q: "Is it built for solo practitioners?", a: "Yes, specifically. It is designed for one-practitioner practices, not scaled down from hospital software." },
  { q: "How do I get in touch?", a: "Email hello@clinexy.com. See the contact page for more options." },
  { q: "Can I try it?", a: "Yes. A 14-day free trial with no credit card required." },
];
...
export default function AboutPage() {
  return (
    <>
        ...
        <div className="hero-inner">
          <div className="hero-content">
            ...
            <div className="hero-ctas">
              <a href="https://demo.clinexy.com/portal/onboarding-request" className="btn btn-primary btn-lg" id="about-hero-trial">Start Free Trial</a>
              <a href="https://demo.clinexy.com/portal/onboarding-request" className="btn btn-secondary btn-lg" id="about-hero-demo">Book a Demo</a>
            </div>
      ...
      {/* CTA */}
      <section className="section section-cta" style={{ background: 'linear-gradient(135deg, #0d1b2e 0%, #1b3a6b 100%)', color: 'white', textAlign: 'center' }}>
        <div className="container">
          <h2 style={{ color: 'white', marginBottom: '10px' }}>Build, brand, and grow your practice</h2>
          <p style={{ color: 'rgba(255,255,255,0.7)', marginBottom: '28px', fontSize: '16px' }}>
            Start free today. The whole platform, set up in a day.
          </p>
          <div className="hero-ctas" style={{ justifyContent: 'center' }}>
            <a href="https://demo.clinexy.com/portal/onboarding-request" className="btn btn-primary btn-lg" id="about-cta-trial">Start Free Trial</a>
            <a href="https://demo.clinexy.com/portal/onboarding-request" className="btn btn-ghost-light btn-lg" id="about-cta-demo">Book a Demo</a>
          </div>
        </div>
      </section>
