...
export const metadata: Metadata = {
  ...
  description: "PDPA-compliant clinic software for Malaysian doctors. WhatsApp reminders.",
...
<h1>Built for Malaysian doctors</h1>
<p className="hero-sub">PDPA-aware. FPX payments.</p><ul className="point-list hero-points"><li>Get found by patients searching for your specialty.</li><li>Fill your calendar and cut no-shows automatically.</li><li>Run bookings, branding, and reviews from one place.</li></ul>
...
<img className="hero-photo" src="/assets/img/growth.svg" alt="Built for Malaysian doctors" loading="eager" width="600" height="420" />
<div className="hero-photo-badge">
<div className="badge-dot"></div><span>Live booking system</span>
</div></div>
</div>
</div></header>
<nav className="breadcrumbs"><div className="container"><Link href="/">Home</Link><span className="crumb-sep">›</span><span className="crumb-current">My</span></div></nav>
