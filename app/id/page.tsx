...
export const metadata: Metadata = {
  title: "Clinic Software for Indonesian Doctors",
  description: "Mobile-first clinic software for Indonesian dokter. WhatsApp reminders, online bookings.",
...
<h1>Built for Indonesian dokter</h1>
<p className="hero-sub">Mobile-first. WhatsApp reminders. GoPay-ready.</p><ul className="point-list hero-points"><li>Get found by patients searching for your specialty.</li><li>Fill your calendar and cut no-shows automatically.</li><li>Run bookings, branding, and reviews from one place.</li></ul>
...
<img className="hero-photo" src="/assets/img/growth.svg" alt="Built for Indonesian dokter" loading="eager" width="600" height="420" />
<div className="hero-photo-badge">
<div className="badge-dot"></div><span>Live booking system</span>
</div></div>
</div>
</div></header>
<nav className="breadcrumbs"><div className="container"><Link href="/">Home</Link><span className="crumb-sep">›</span><span className="crumb-current">Id</span></div></nav>
...
<section className="section section-related"><div className="container"><h2>Related pages</h2><div className="related-grid"><Link className="related-card" href="/in"><h4>Built for Indian solo doctors</h4><p>Built for Indian solo doctors. WhatsApp-first. ABDM-ready. ₹999/month.</p><span className="related-arrow">→</span></Link><Link className="related-card" href="/ph"><h4>Built for Filipino doctors</h4><p>Simple clinic software for Filipino solo doctors. Bookings, reminders, telehealth.</p><span className="related-arrow">→</span></Link><Link className="related-card" href="/my"><h4>Built for Malaysian doctors</h4><p>PDPA-compliant clinic software for Malaysian doctors. WhatsApp reminders.</p><span className="related-arrow">→</span></Link></div></div></section>
