...
export const metadata: Metadata = {
  title: "Clinic Software for Filipino Doctors",
  description: "Simple clinic software for Filipino solo doctors. Bookings, reminders, telehealth.",
...
<h1>Built for Filipino doctors</h1>
<p className="hero-sub">GCash and PayMaya ready. PhilHealth-aware.</p><ul className="point-list hero-points"><li>Get found by patients searching for your specialty.</li><li>Fill your calendar and cut no-shows automatically.</li><li>Run bookings, branding, and reviews from one place.</li></ul>
...
<img className="hero-photo" src="/assets/img/growth.svg" alt="Built for Filipino doctors" loading="eager" width="600" height="420" />
<div className="hero-photo-badge">
<div className="badge-dot"></div><span>Live booking system</span>
</div></div>
</div>
</div></header>
<nav className="breadcrumbs"><div className="container"><Link href="/">Home</Link><span className="crumb-sep">›</span><span className="crumb-current">Ph</span></div></nav>
