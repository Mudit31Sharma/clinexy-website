...
export const metadata: Metadata = {
  title: "Doctor Branding & Practice Growth — Clinexy",
...
export default function DoctorBrandingGrowthPage() {
  return (
    <>
      <header className="hero">
        <div className="hero-inner">
          <div className="hero-content">
            <span className="tag">Practice Growth</span>
            ...
            <div className="hero-ctas">
              <a href="https://demo.clinexy.com/portal/onboarding-request" className="btn btn-primary btn-lg" id="branding-growth-trial">Start Free Trial</a>
              <a href="https://demo.clinexy.com/portal/onboarding-request" className="btn btn-secondary btn-lg" id="branding-growth-demo">Book a Demo</a>
            </div>
          ...
          <div className="hero-image">
            <div className="hero-svg-wrap" style={{ padding: '24px', background: 'rgba(255,255,255,0.06)', borderRadius: '12px' }}>
              <div style={{ color: 'white', textAlign: 'center', padding: '20px' }}>
                <div style={{ fontSize: '2.5rem', fontWeight: 800, color: '#4ade80', marginBottom: '8px' }}>₹999/mo</div>
                <div style={{ fontSize: '14px', color: 'rgba(255,255,255,0.7)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Flat India Pricing</div>
                <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', marginTop: '20px', paddingTop: '20px' }}>
                  <div style={{ fontSize: '13px', fontStyle: 'italic', color: 'rgba(255,255,255,0.9)' }}>&ldquo;Clinexy handles my online presence while I concentrate on treatments. Best upgrade I've made.&rdquo;</div>
                  <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.5)', marginTop: '6px' }}>— Dr. Emma, Chelsea/London</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <nav className="breadcrumbs" aria-label="Breadcrumb">
        <div className="container">
          ...
          <span className="crumb-current">Doctor Branding &amp; Practice Growth</span>
        </div>
      </nav>
      ...
      <aside className="quick-answer container" style={{ maxWidth: '860px' }}>
        <div className="quick-answer-inner">
          ...
          <p>
            Doctor Branding &amp; Practice Growth from Clinexy is built specifically for solo healthcare professionals. It is included in the base subscription with no add-on fees and no per-appointment commissions. Setup takes minutes, and works across regions with compliance for HIPAA, GDPR, PIPEDA, PDPA, and DPDP.
          </p>
        </div>
      </aside>
      ...
      <section className="section">
        <div className="container section-narrow">
          ...
          <p className="prose">
            Clinexy solves this by shipping Doctor Branding &amp; Practice Growth tools directly as part of the base subscription. You get a professionally designed website on your own domain, automated review requests that fire after appointments, and local SEO optimizations pre-configured for your practice type and city.
          </p>
        </div>
      </section>
