...
export const metadata: Metadata = {
  title: "Doctor Branding & Practice Growth",
  ...
  alternates: { canonical: "https://www.clinexy.com/doctor-branding-growth" },
};
...
const jsonLd2 = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Doctor Branding Growth",
      "item": "https://www.clinexy.com/doctor-branding-growth"
    }
  ]
};
...
const jsonLd3 = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is Doctor Branding & Practice Growth included in the plan?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does Doctor Branding & Practice Growth work for my specialty?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Can I integrate Doctor Branding & Practice Growth with my existing tools?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<h1>Doctor Branding & Practice Growth</h1>
...
<img className="hero-photo" src="/assets/img/branding.svg" alt="Doctor Branding & Practice Growth" loading="eager" width="600" height="420" />
<div className="hero-photo-badge">
<div className="badge-dot"></div><span>Live booking system</span>
</div></div>
</div>
</div></header>
<nav className="breadcrumbs"><div className="container"><Link href="/">Home</Link><span className="crumb-sep">›</span><span className="crumb-current">Doctor Branding Growth</span></div></nav>
<aside className="quick-answer container"><div className="quick-answer-inner"><div className="quick-answer-label">Quick answer</div><p>Doctor Branding & Practice Growth from Clinexy is built specifically for solo healthcare professionals. It is included in the base subscription with no add-on fees and no per-appointment commissions. Setup takes minutes, not days, and works across regions with compliance for HIPAA, GDPR, PIPEDA, PDPA, and DPDP.</p></div></aside>
<section className="section"><div className="container"><h2>What is Doctor Branding & Practice Growth</h2><p className="lead">Doctor Branding & Practice Growth is the part of Clinexy that handles this specific job for your practice.</p></div></section>
...
<section className="section"><div className="container"><h2>How Clinexy solves it</h2><p className="lead">Clinexy ships Doctor Branding & Practice Growth as part of the base subscription. No add-on fees. No setup work. Templates pre-configured for solo practice.</p></div></section>
