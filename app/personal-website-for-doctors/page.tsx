...
const jsonLd2 = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Personal Website For Doctors",
      "item": "https://www.clinexy.com/personal-website-for-doctors"
    }
  ]
};
...
const jsonLd3 = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is Personal Website for Doctors included in the plan?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does Personal Website for Doctors work for my specialty?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Can I integrate Personal Website for Doctors with my existing tools?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<p className="hero-sub">Patients land on your brand, not a directory. Set up in under 30 minutes.</p><ul className="point-list hero-points"><li>Look credible the moment patients land.</li><li>Turn website visitors into booked appointments.</li><li>Own your presence on your own domain.</li></ul>
...
<img className="hero-photo" src="/assets/img/website.svg" alt="Personal Website for Doctors" loading="eager" width="600" height="420" />
<div className="hero-photo-badge">
<div className="badge-dot"></div><span>Live booking system</span>
</div></div>
</div>
</div></header>
<nav className="breadcrumbs"><div className="container"><Link href="/">Home</Link><span className="crumb-sep">›</span><span className="crumb-current">Personal Website For Doctors</span></div></nav>
<aside className="quick-answer container"><div className="quick-answer-inner"><div className="quick-answer-label">Quick answer</div><p>Personal Website for Doctors from Clinexy is built specifically for solo healthcare professionals. It is included in the base subscription with no add-on fees and no per-appointment commissions. Setup takes minutes, not days, and works across regions with compliance for HIPAA, GDPR, PIPEDA, PDPA, and DPDP.</p></div></aside>
<section className="section"><div className="container"><h2>What is Personal Website for Doctors</h2><p className="lead">Personal Website for Doctors is the part of Clinexy that handles this specific job for your practice.</p></div></section>
...
<section className="section"><div className="container"><h2>How Clinexy solves it</h2><p className="lead">Clinexy ships Personal Website for Doctors as part of the base subscription. No add-on fees. No setup work. Templates pre-configured for solo practice.</p></div></section>
