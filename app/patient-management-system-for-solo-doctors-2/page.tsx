...
const jsonLd2 = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Patient Management System For Solo Doctors 2",
      "item": "https://www.clinexy.com/patient-management-system-for-solo-doctors-2"
    }
  ]
};
...
const jsonLd3 = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is Patient Management System included in the plan?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does Patient Management System work for my specialty?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Can I integrate Patient Management System with my existing tools?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<p className="hero-sub">All patient information in one secure place. Searchable, exportable, encrypted at rest.</p><ul className="point-list hero-points"><li>Get found by patients searching for your specialty.</li><li>Fill your calendar and cut no-shows automatically.</li><li>Run bookings, branding, and reviews from one place.</li></ul>
...
<img className="hero-photo" src="/assets/img/growth.svg" alt="Patient Management System" loading="eager" width="600" height="420" />
<div className="hero-photo-badge">
<div className="badge-dot"></div><span>Live booking system</span>
</div></div>
</div>
</div></header>
<nav className="breadcrumbs"><div className="container"><Link href="/">Home</Link><span className="crumb-sep">›</span><span className="crumb-current">Patient Management System For Solo Doctors 2</span></div></nav>
<aside className="quick-answer container"><div className="quick-answer-inner"><div className="quick-answer-label">Quick answer</div><p>Patient Management System from Clinexy is built specifically for solo healthcare professionals. It is included in the base subscription with no add-on fees and no per-appointment commissions. Setup takes minutes, not days, and works across regions with compliance for HIPAA, GDPR, PIPEDA, PDPA, and DPDP.</p></div></aside>
<section className="section"><div className="container"><h2>What is Patient Management System</h2><p className="lead">Patient Management System is the part of Clinexy that handles this specific job for your practice.</p></div></section>
...
<section className="section"><div className="container"><h2>How Clinexy solves it</h2><p className="lead">Clinexy ships Patient Management System as part of the base subscription. No add-on fees. No setup work. Templates pre-configured for solo practice.</p></div></section>
